...
const Header: React.FC = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.166 3c.445 0 3.334.007 4.709 1.382.39.39.39 1.023 0 1.414-.39.39-1.024.39-1.414 0C14.833 5.168 13.084 5 12.166 5c-.918 0-2.667.168-3.295.796-.39.391-1.024.391-1.414 0-.391-.391-.391-1.024 0-1.414C8.832 3.007 11.721 3 12.166 3zm7.478 5.546c.054.097.054.217 0 .314l-1.293 2.315c-.14.25-.385.426-.673.485-.287.058-.581-.012-.808-.192l-1.293-.863c-.227-.151-.517-.208-.797-.157-.281.051-.529.206-.684.427l-.855 1.218c-.155.221-.403.376-.684.427-.28.051-.57-.006-.797-.157l-1.293-.863c-.227-.18-.521-.25-.808-.192-.288.059-.533.235-.673.485L8.356 8.86c-.054-.097-.054-.217 0-.314L9.98 6.76c.305-.546 1.107-.732 1.653-.427.546.305.732 1.107.427 1.653L11.5 8.89h1l-.56-.904c-.305-.546-.119-1.348.427-1.653.546-.305 1.348-.119 1.653.427l1.624 2.786z"/>
        </svg>
      )
    },
    {
