...
const Header: React.FC = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.166 3c2.4 0 4.334 1.95 4.334 4.364 0 2.888-1.166 5.182-2.834 6.818-.334.334-.834.334-1.166 0C10.832 12.546 9.666 10.252 9.666 7.364 9.666 4.95 11.766 3 12.166 3zM8.5 6c-.828 0-1.5.672-1.5 1.5S7.672 9 8.5 9 10 8.328 10 7.5 9.328 6 8.5 6zm7 0c-.828 0-1.5.672-1.5 1.5S14.672 9 15.5 9 17 8.328 17 7.5 16.328 6 15.5 6zM12 21c-1.5 0-3-1-3-2.5 0-.5.5-1 1-1h4c.5 0 1 .5 1 1 0 1.5-1.5 2.5-3 2.5z"/>
        </svg>
      )
    },
    {
