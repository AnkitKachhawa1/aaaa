...
const Header: React.FC = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.69 13.742 3.69 12.445c0-1.297.508-2.449 1.436-3.324C5.951 8.245 7.104 7.755 8.4 7.755c1.297 0 2.449.49 3.324 1.366.875.875 1.297 2.027 1.297 3.324 0 1.297-.422 2.45-1.297 3.324-.875.876-2.027 1.366-3.324 1.366zm7.718-6.695c-.508 0-.875-.367-.875-.875s.367-.875.875-.875.875.367.875.875-.367.875-.875.875z"/>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM15.156 16.562c-1.092 0-1.745-.734-2.125-1.375-.38.641-1.033 1.375-2.125 1.375-2.187 0-3.969-1.781-3.969-3.969s1.781-3.969 3.969-3.969c2.187 0 3.969 1.781 3.969 3.969s-1.781 3.969-3.969 3.969z"/>
        </svg>
      )
    },
    {
