      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © {new Date().getFullYear()} <a href="/" className="hover:underline">YourCompany™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0 gap-6">
            ...
            {/* Facebook */}
            <a href="#" className="text-gray-500 hover:text-blue-700 dark:hover:text-blue-500">
              <svg className="w-6 h-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M13.135 6H15V3h-1.865a4.147 4.147 0 0 0-4.142 4.142V9H7v3h2v9.938h3V12h2.021l.592-3H12V6.591A.6.6 0 0 1 12.592 6h.543Z" clipRule="evenodd"/>
              </svg>
            </a>
            {/* Instagram */}
            <a href="#" className="text-gray-500 hover:text-pink-500 dark:hover:text-pink-400">
            ...
            {/* Phone Call */}
            <a href="tel:+919999999999" className="text-gray-500 hover:text-emerald-500 dark:hover:text-emerald-400">
              <svg className="w-6 h-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
