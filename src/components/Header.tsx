...
const Header: React.FC = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.514 0 10 4.486 10 10s-4.486 10-10 10S2 17.514 2 12 6.486 2 12 2zm-2.5 6c-.828 0-1.5.672-1.5 1.5s.672 1.5 1.5 1.5S11 10.328 11 9.5 10.328 8 9.5 8zm5 0c-.828 0-1.5.672-1.5 1.5s.672 1.5 1.5 1.5 1.5-.672 1.5-1.5S15.328 8 14.5 8zM12 20c-1.657 0-3-1.343-3-3h6c0 1.657-1.343 3-3 3z"/>
        </svg>
      )
    },
    {
